...
#define LR_RegFreqErrorMSB													0x28
#define LR_RegFreqErrorMiddle												0x29
#define LR_RegFreqErrorLSB													0x2A
// I/O settings
...
// SX1278_REG_01_OP_MODE                             0x01
#define SX1278_LONG_RANGE_MODE                       0x80
#define SX1278_ACCESS_SHARED_REG                     0x40
#define SX1278_MODE                                  0x07
#define SX1278_MODE_SLEEP                            0x00
#define SX1278_MODE_STDBY                            0x01
#define SX12785_MODE_FSTX                            0x02
...
#define SX1278_MODE_LOW_FREQ													0x08
 ...
 * \return     nothing
 */
void SX1278_LoRaTxPacketStart(SX1278_t *module, uint8_t *txBuf, uint8_t length,
		uint32_t timeout);

/**
 * \brief Send data
 *
 * Transmit data state check
 *
 * \param[in]  module	Pointer to LoRa structure
 * \param[in]  txBuf    Data buffer with data to be sent
 * \param[in]  length   Length of message to be sent
 ...
 * \return     1 if entering reception mode
 *             0 if timeout was exceeded
							2 transmit is ongoing
 */
int SX1278_LoRaTxPacketCheck(SX1278_t *module, uint8_t *txBuf, uint8_t length,
		uint32_t timeout);
